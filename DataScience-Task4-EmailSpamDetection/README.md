...
The objective is to build a Machine Learning model capable of classifying SMS messages as **Spam** or **Ham** using Natural Language Processing (NLP) techniques.
